...
## todo
 ...
 - убрать постоянное обновление страницы при включённом дев сервере vite
 - (опционально) запроксировать дебаг запросы vite на тот же порт, что и нгинкс, а нгинксом - перенаправить на порт vite
